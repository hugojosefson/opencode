...
| deno               | .ts, .tsx, .js, .jsx, .mjs, .cjs, .mts, .cts, .dts, .json, .jsonc, .md, .html, .css, .scss, .sass, .less, .yaml, .sql, .svelte, .vue, .astro | `deno` command available (auto-detects deno.json/deno.jsonc) |
